...
public class AddStudentActivity extends Activity {
	...
	private String[] branchString = new String[] { "IT","MLAI","CSE"};
	private String[] yearString = new String[] {"FY","SY","TY","LY"};
...
//	Cancel.OnClickListener(new OnClickListener() {
//
//		@Override
//		public void onClick(View v) {
//			// TODO Auto-generated method stub
...
//			Intent intent =new Intent(AddStudentActivity.this,MenuActivity.class);
//			startActivity(intent);
//			Toast.makeText(getApplicationContext(), "Returned To the Previous Page", Toast.LENGTH_SHORT).show();
//
//		}
//	});
